...
if __name__ == '__main__':
    folder = r'E:\HE+CAM5\tiff\result_11_27\CAM1127\trianA'  # 存放图片的文件夹
    mkpath = r'E:\HE+CAM5\tiff\result_11_27\CAM1127\trianA\A'
    path = os.listdir(folder)
    mkdir(mkpath)
    for files in path:  # 批量操作
        ...
        print(first_name)
        # 定义要创建的目录
        # mkpath = r"E:\HE+CAM5\tiff\result_11_27\CAM1127\trianA" + '\\' + first_name
        # 调用函数
        # mkdir(mkpath)
